# https://marketplace.visualstudio.com/items?itemName=wangweixuan.yithemes
code --install-extension wangweixuan.yithemes
...
# https://marketplace.visualstudio.com/items?itemName=be5invis.toml
